...
export default function TopNav() {
  ...
  return (
    <header className="fixed left-0 top-0 z-50 w-full border-b border-white/10 bg-background/85 backdrop-blur-md">
      <nav className="mx-auto flex h-16 max-w-6xl items-center justify-between px-6 md:px-12">
        ...
        <button
          ...
          className="inline-flex h-10 w-10 items-center justify-center rounded-full border border-white/10 text-muted transition hover:border-primary/40 hover:text-primary md:hidden"
        >
      ...
      {open && (
        <div className="border-t border-white/10 bg-background/95 px-6 py-4 backdrop-blur-md md:hidden">
